...
import { handleGoogleSignIn, initializeLoginFramework,handleSignOut, createUserWithEmailAndPassword, signInWithEmailAndPassword, handleFbSignIn, resetPassword } from './LoginManager';
      ...
      <Header></Header>
        <div id="login" className="mx-auto p-3 rounded" style={{textAlign: 'center'}}>
          <Form onSubmit={handleSubmit}>
                    ...
                    <span className="btn btn my-4 text-light btn-block w-100 mx-auto" onClick={()=>{
                        setNewUser(!newUser);
                        setUser({
                            signed: false,
                            name: user.name,
